...
static void GenerateFileSignature(string filePath)
{
...
static int CalculateBlockSize(long fileSize, int defaultBlockSize)
{
    ...
    return Math.Min(blockSize, availableMemory);
}
